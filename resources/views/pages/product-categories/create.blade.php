...
@section('title-meta')
    <title>{{ config('app.name') }} | Item Category Create</title>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-title">
                            <h5>Fill out this form to create a new Item Category.</h5>
                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="{{ route('product-categories.store') }}"
