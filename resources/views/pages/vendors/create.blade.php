...
@section('title-meta')
    <title>{{ config('app.name') }} | Suplier Create</title>
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-4">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a href="{{ route('vendors.index') }}">Supliers</a>
                    </li>
                    <li class="active">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-title">
                            <h5>Fill out this form to create a new Suplier.</h5>
                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="{{ route('vendors.store') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="number" class="form-control @error('code') is-invalid @enderror "
                                            name="code" value="{{ old('code') ?? $currentCode }}" required>
                                        @error('code')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="address" id="" cols="4" rows="3"
                                            class="form-control @error('adress') is-invalid @enderror"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control @error('ntn') is-invalid @enderror"
                                            name="ntn" value="{{ old('ntn') }}" required>
                                        @error('ntn')
                                            <span class="invalid-feedback text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control @error('stn') is-invalid @enderror"
                                            name="stn" value="{{ old('stn') }}" required>
                                        @error('stn')
                                            <span class="invalid-feedback text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
