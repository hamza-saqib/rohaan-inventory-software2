...
@section('title-meta')
    <title>{{ config('app.name') }} | Unit Edit</title>
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-4">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a href="{{ route('measurements.index') }}">Unit</a>
                    </li>
                    <li class="active">
                        <strong>Edit</strong>
                    </li>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-title">
                            <h5><small>From here you can edit your new units.</small></h5>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="number" class="form-control @error('factor') is-invalid @enderror"
                                            name="factor" value="{{ $measurement->factor }}" required>
                                        @error('factor')
                                            <span class="invalid-feedback text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"
                                            ...
                                            name="description" value="{{ $measurement->descrip }}" required>
                                        @error('description')
                                            <span class="invalid-feedback text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
