                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="{{ route('recieve-inventories.store') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="number" class="form-control @error('grn') is-invalid @enderror "
                                            name="grn" value="{{ old('grn') ?? $currentCode }}" required>
                                        @error('grn')
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text"
                                            ...
                                            name="voucher_no" value="{{ old('voucher_no') ?? $currentCode }}" required>
                                        @error('voucher_no')
                                            <span class="invalid-feedback text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input required type="text" class="form-control has-error" name="vendor_inv"
                                            value="{{ old('vendor_inv') ?? $currentSIN }}">
                                    </div>
                                    ...
                                    <div class="col-sm-2 @error('vendor_inv_date') has-error @enderror">
                                        <input type="date" class="form-control" name="vendor_inv_date"
                                            value="{{ old('vendor_inv_date') ?? date('Y-m-d') }}" required>
