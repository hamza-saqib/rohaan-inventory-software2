                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    <select data-placeholder="Select Supplier" class="chosen-select" tabindex="2" id="productSelect" name="vendor_code" required>
...
<script>
    ...
    $(document).ready(function() {
        $('.dataTables-example').DataTable({
            ...
            buttons: [{
                    extend: 'pdf',
                    title: 'CONTINENTAL AIR CONTROL (PVT) LTD.\n ' + 'Supplier Sales Tax Report Of: ' + supplier + ' - ' + SupplierName + '\n( From: ' + sDate + ' To: ' + eDate + ' )',
                    orientation: 'landscape',
                    filename: 'Supplier Sales Tax Report Of: ' + supplier + ' - ' + SupplierName + '( From: ' + sDate + ' To: ' + eDate + ' )',
