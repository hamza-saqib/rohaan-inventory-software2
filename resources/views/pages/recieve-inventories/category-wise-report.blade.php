        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                <div class="ibox-content m-b-sm border-bottom">
                    <div class="row">
                        <form action="{{ route('reports.recieve-inventories.category') }}" method="GET">
                            @csrf
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label" for="date_modified">Item Category</label>
                                    <div class="input-group date">
                                        <select data-placeholder="Select Category" class="chosen-select" tabindex="2"
                                        id="productSelect" name="category_code" required>
                                            ...
                                            @foreach ($categories as $category)
                                                ...
                                                @else
                                                    <option value="{{ $category->code }}">
                                                        {{ $category->code . ' - ' . $category->name1 }}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                    </div>
